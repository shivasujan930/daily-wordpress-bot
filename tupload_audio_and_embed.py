...
# Step 1: Upload MP3 to WordPress Media
def upload_audio_to_wp(file_path):
    ...
    print("✅ Uploaded to media:", response.json()["source_url"])
    return response.json()["source_url"]

# Step 2: Embed audio in latest post
def embed_audio_in_latest_post(audio_url):
    ...
    current_content = latest_post["content"]["raw"] or latest_post["content"]["rendered"]
